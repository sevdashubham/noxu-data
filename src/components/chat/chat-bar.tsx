...
export const ChatBar = () => {
    return (
        <form className="flex flex-row pt-4 gap-2 flex-1">
            <div className="flex flex-row flex-1">
                ...
                <div className="relative flex flex-1 gap-2">
                    <input type="search" id="location-search"
                           className="flex-1 w-full px-3 py-2 text-slate-400 text-base leading-6 font-normal rounded-e-md border-s-gray-50 border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                           placeholder={CHAT_INPUT_PLACEHOLDER} required/>
                    <button type="button" className="absolute inset-y-0 end-0 flex items-center px-3">
                        <NoxuIcon icon={'chat-send'} height={24} width={24}/>
                    </button>
                </div>
            </div>
