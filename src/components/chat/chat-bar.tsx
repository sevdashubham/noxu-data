...
export const ChatBar = () => {
    ...
    const handleSubmit = () => {
        socket.emit(SOCKET_EVENT, chatInput.trim());
    }
    return (
        <form className="flex flex-row pt-4 gap-4 flex-1">
            <div className="flex flex-row flex-1">
                ...
                <div className="relative flex flex-1 gap-2">
                    <input type="search" id="location-search" onChange={handleInput}
                    ...
                    <button type="button" className="absolute inset-y-0 end-0 flex items-center px-3" onClick={handleSubmit}>
